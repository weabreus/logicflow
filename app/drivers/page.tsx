...
function page() {
  ...
  useLayoutEffect(() => {
    const isIndeterminate =
      selectedPeople.length > 0 && selectedPeople.length < drivers.length;
    setChecked(selectedPeople.length === drivers.length);
        ...
        <div className="sm:flex sm:items-center">
          <div className="sm:flex-auto">
            ...
            <p className="mt-2 text-sm text-gray-700">
              Una lista con todos los transportistas en su cuenta.
            </p>
          </div>
