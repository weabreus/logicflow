...
const Form: React.FC<{
...
}> = ({ open, setOpen, setDrivers, getDrivers }) => {
  ...
  const handleSubmit = async (event: FormEvent) => {
    ...
    const response = await fetch("/api/drivers/drivers", {
      method: "POST",
    ...
    // If the form was submitted successfully, redirect to a success page
                    ...
                    <div className="bg-indigo-500 py-6 px-4 sm:px-6">
                      ...
                      <div className="mt-1">
                        <p className="text-sm text-indigo-300 text-left">
                          Llene la información requerida para agregar al
                          transportista.
                        </p>
                      </div>
                    </div>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                              ...
                              <div className="col-span-1">
                                ...
                                >
                                  ...
                                  <option value={"16 pies"}>
                                    Camion rigido (16 pies)
                                  </option>
                                  <option value={"20 pies"}>
                                    Camion rigido (20 pies)
                                  </option>
                                  <option value={"26 pies"}>
                                    Camion rigido (26 pies)
                                  </option>
